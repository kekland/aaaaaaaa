...
EXTERNC FLMLN_EXPORT std_array_float_2_t mbgl_style_std_array_float_2_create(float v0, float v1);
EXTERNC FLMLN_EXPORT void mbgl_style_std_array_float_2_destroy(std_array_float_2_t ptr_);
...
EXTERNC FLMLN_EXPORT std_vector_float_t mbgl_style_std_vector_float_create(size_t length_, float* values_);
EXTERNC FLMLN_EXPORT void mbgl_style_std_vector_float(std_vector_float_t ptr_);
...
EXTERNC FLMLN_EXPORT std_array_float_4_t mbgl_style_std_array_float_4_create(float v0, float v1, float v2, float v3);
EXTERNC FLMLN_EXPORT void mbgl_style_std_array_float_4_destroy(std_array_float_4_t ptr_);
...
EXTERNC FLMLN_EXPORT std_vector_const_char_t mbgl_style_std_vector_const_char_create(size_t length_, const char** values_);
EXTERNC FLMLN_EXPORT void mbgl_style_std_vector_const_char(std_vector_const_char_t ptr_);
...
EXTERNC FLMLN_EXPORT std_vector_mbgl_style_text_variable_anchor_t mbgl_style_std_vector_mbgl_style_text_variable_anchor_create(size_t length_, enum MBGL_STYLE_TEXT_VARIABLE_ANCHOR* values_);
EXTERNC FLMLN_EXPORT void mbgl_style_std_vector_mbgl_style_text_variable_anchor(std_vector_mbgl_style_text_variable_anchor_t ptr_);
...
EXTERNC FLMLN_EXPORT std_vector_mbgl_style_text_writing_mode_t mbgl_style_std_vector_mbgl_style_text_writing_mode_create(size_t length_, enum MBGL_STYLE_TEXT_WRITING_MODE* values_);
EXTERNC FLMLN_EXPORT void mbgl_style_std_vector_mbgl_style_text_writing_mode(std_vector_mbgl_style_text_writing_mode_t ptr_);
