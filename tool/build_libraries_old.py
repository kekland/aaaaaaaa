...
#     subprocess.run(
#         shlex.split(f'bazel build //platform/flutter:flmbgl_ios_universal --//:renderer=metal {BZL_FLAGS}'), 
#         cwd=maplibre_native_root,
#         check=True
#     )

#     # Copy the built dynamic library to the plugin directory
#     bazel_out_ios_dynamic_library = maplibre_native_root / 'bazel-bin/platform/flutter/libfmbgl_ios.dylib'
#     ios_dynamic_library = plugin_root / 'darwin/Libraries/ios/libfmbgl_ios.dylib'
